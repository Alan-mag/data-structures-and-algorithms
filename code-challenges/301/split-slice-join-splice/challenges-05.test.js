...
const listFoods = (recipe) => { // will return - got food, but they want full names? ex: brown sugar instead of 'sugar' (make arr?)
  let result = [];
  // Solution code here...
  let ingr = gruffaloCrumble.ingredients;
  ingr.forEach((ingr) => {
    result.push(ingr.slice(ingr.lastIndexOf(' ') + 1))
  })
  return result;
}
